...
/**
 * Point d'entrée principal de l'application e-commerce console.
 * Permet à l'utilisateur de gérer un panier, ajouter/retirer des articles,
 * appliquer une promotion, et voir le total.
 */
public class Main {
